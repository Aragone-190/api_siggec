...
module.exports = app => {
    ...
    app.getTotalIndiciosPerito = (req, res) => {
        let body = req.body;
        console.log(body);
    ...
    app.getTotalFolderxPerito = (req, res) => {
        var perito = req.body.usuario;
        ...
        .then(result => {
            ...
            datos.forEach(c => {
                if (datos[contU] == c) {
                    ...
                    datosU.push({ 'nuc': c, registros: contadorReg(datos, c) });
                }
            });

            function contadorReg(a, b) {
                let contRegis = 0;
                for (let co = 0; co < a.length; co++) {
                    if (b == a[co]) {
                        contRegis++;
                    }
                }
